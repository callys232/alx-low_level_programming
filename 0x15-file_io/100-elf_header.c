...
/**
 * check_elf - checks if a fle is an ELF file.
 ...
 * @e_ident: A pointer to an array containing tje ELF vrsion.
 */
void print_version(unsigned char *e_ident)
{
	print(" Version:			%d",
